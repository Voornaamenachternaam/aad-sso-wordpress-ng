...
class AADSSO_GraphHelper
{
    ...
    public static function get_request(string $url, array $query_params = []): mixed
    {
    ...
    public static function post_request(string $url, array $query_params = [], array $data = []): mixed
    {
        $query_params = http_build_query($query_params);
        $url = $url . '?' . $query_params;
